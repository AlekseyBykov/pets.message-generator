...
import alekseybykov.pets.mg.gui.components.panels.tbbigattr.TBMessageBigAttributesTablePanel;
 ...
 */
@Component
public class RefreshTBMessageBigAttributesTableButtonClickListener implements ActionListener {

	@Autowired
	@Qualifier("TBMessageBigAttributesPaginatorService")
	private PageableDataService backendService;
	@Autowired
	private TBMessageBigAttributesTablePanel tablePanel;
	@Autowired
	...
	private void loadPaginatorData(final JProgressBar progressBar,
	                               final TBMessageBigAttributesTableModel tableModel) {
	...
	private void loadTableDataRange(final TBMessageBigAttributesTableModel tableModel,
