...
import alekseybykov.pets.mg.gui.components.listeners.queuein.RefreshIncomeQueueTableButtonClickListener;
 ...
 */
@Component
public class RefreshIncomeQueueTableButton extends JButton {

	@Autowired
	private RefreshIncomeQueueTableButtonClickListener refreshIncomeQueueTableButtonClickListener;
	...
	private void postConstruct() {
		...
		addActionListener(refreshIncomeQueueTableButtonClickListener);
	}
}
