package alekseybykov.pets.mg.dao.queueout.impl;
...
public class OutcomeQueueDaoImpl implements OutcomeQueueDao {
	...
	private static final Logger logger = LoggerFactory.getLogger(OutcomeQueueDaoImpl.class);

	@Autowired
	private OutcomeQueueRowMapper rowMapper;
	/*@Autowired
	private OutcomeQueueBlobMapper blobMapper;*/

	@Override
	public PageableData fetchRowById(int id) {
		PageableData row = null;

		val sqlText = "\nselect * from queue_packet_out where id = ?\n\n";
